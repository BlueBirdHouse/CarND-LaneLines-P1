...
def Left_Right_eye(img):
    ...
    Level = 320
    #设定顶点
    vertices_L = np.array([[(0,imshape[0]),((imshape[1]/2 - Offset),Level),((imshape[1]/2),Level),((imshape[1]/2),imshape[0])]],dtype = np.int)
    vertices_R = np.array([[((imshape[1]/2),imshape[0]),((imshape[1]/2),Level),((imshape[1]/2 + Offset),Level),(imshape[1],imshape[0])]],dtype = np.int)
